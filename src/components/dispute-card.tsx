...
export function DisputeCard({ dispute }: DisputeCardProps) {
  ...
  return (
    <Link
      ...
      className="block rounded-lg border-b p-4 transition-colors hover:bg-accent/10 focus:outline-none focus:ring-2 focus:ring-ring"
    >
      <Card className="shadow-md">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between text-muted-foreground">
            ...
            {dispute.status === 'voting' && <Badge>Voting Open</Badge>}
